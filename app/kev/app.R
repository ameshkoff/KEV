...
source("app/ui/ui_eq.r")
source("app/ui/ui_ab.r")
source("app/ui/ui_sp.r")
source("app/ui/ui_emf.r")
source("app/ui/ui_nm.r")
source("app/ui/ui_cur.r")
...
server <- function(input, output, session) {
  ...
  source("app/server/server_modules.r", local = TRUE)  
