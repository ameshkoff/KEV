...
server <- function(input, output, session) {
  ...
  source("web/server/emf_download.handlers.r", local = TRUE)
  source("web/server/nm_download.handlers.r", local = TRUE)
  source("web/server/cur_download.handlers.r", local = TRUE)
