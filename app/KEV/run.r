...
eq.evaluation.runner(app = FALSE, sep = "tab", subdir = "ds.5p.tab", bs.name = "molecule4", thr.type = c("abs"), threshold = 1e-08, save.res = TRUE)
...
eq.evaluation.runner(app = FALSE, sep = "tab", subdir = "ds.5p.tab", bs.name = "molecule4", thr.type = c("abs"), threshold = 1e-08, save.res = FALSE)
